...
@objcMembers open class ZSPlainFlowLayout: UICollectionViewFlowLayout {
    ...
    public var plainSection: Int = NSNotFound
    ...
    override open func layoutAttributesForElements(in rect: CGRect) -> [UICollectionViewLayoutAttributes]? {
        ...
        {
            if sectionHeadersPinToVisibleBounds || plainSection == NSNotFound
            {
                return origins
            }
        }
        
        var superAttributesArray: [UICollectionViewLayoutAttributes] = origins.map({$0.copy() as! UICollectionViewLayoutAttributes})
        ...
        for attributes in superAttributesArray
        {
            if attributes.representedElementKind == UICollectionView.elementKindSectionHeader
            {
                ...
                if plainSection == NSNotFound || section == plainSection
                {
