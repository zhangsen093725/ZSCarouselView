...
@objc public protocol ZSCubeCarouseViewDataSource {
...
@objc public protocol ZSCubeCarouseViewDelegate {
...
@objcMembers open class ZSCubeCarouseView: UIView {
    ...
    /// 滚动视图的数据配置
    public weak var dataSource: ZSCubeCarouseViewDataSource?
    
    /// 滚动视图的交互
    public weak var delegate: ZSCubeCarouseViewDelegate?
